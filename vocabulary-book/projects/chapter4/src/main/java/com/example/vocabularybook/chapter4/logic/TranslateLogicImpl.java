...
import com.example.vocabularybook.chapter4.dataaccess.BookAccessor;
import com.example.vocabularybook.chapter4.dataaccess.BookOnFileImpl;
...
public class TranslateLogicImpl implements TranslateLogic {
    ...
    // 単語帳データへのアクセス<1>
    private BookAccessor book = new BookOnFileImpl();
